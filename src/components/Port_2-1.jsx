...
const Port = () => {
  ...
  const horizontalRef = useRef(null); // ref: 전체 섹션(ScrollTrigger pin 대상)
  const sectionRef = useRef(null); // ref: 가로로 움직일 wrap 전체 요소
  const titleRef = useRef(null); // ref: 제목 영역 (너비 계산 기준)
  ...
  useEffect(() => {
    ...
    console.log(trigger.end, "trigger")
